...
public class CommentController {
    ...
    public ResponseEntity<PostResponse> addComment(
        ...
        PostResponse response = commentService.insertComment(commentRequest, currentUser);
    ...
    public ResponseEntity<PostResponse> editComment(
        ...
        PostResponse response = commentService.updateComment(id, commentRequest, currentUser);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<PostResponse> deleteComment(
        ...
        PostResponse response = commentService.deleteComment(id, currentUser);
        return ResponseEntity.ok(response);
    }
